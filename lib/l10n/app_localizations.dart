...
class AppLocalizations {
  ...
  String responseDueBy(Object time, Object day) {
    final DateFormat timeDateFormat = DateFormat.Hm(_localeName);
    final String timeString = timeDateFormat.format(time);

    final DateFormat dayDateFormat = DateFormat.yMMMMEEEEd(_localeName);
    final String dayString = dayDateFormat.format(day);

    return Intl.message(
      'The response is due by $timeString on $dayString.',
      locale: _localeName,
      name: 'responseDueBy',
      desc: r'Response due time',
      args: <Object>[timeString, dayString]
    );
  }
